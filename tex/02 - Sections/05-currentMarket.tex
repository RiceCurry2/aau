\section{Current solutions for the demining process}
...
\end{figure} \todo{This cut out table is quite crap, we should make something that's relevant for this project \#notflaming}
