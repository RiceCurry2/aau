...
#include "ros_tutorials_topic/MsgTutorial.h"
    ...
    // the 'MsgTutorial' message of the 'ros_tutorials_topic' package is recieved.

    void MsgCallback(const ros_tutorials_topic::MsgTutorial::ConstPtr& msg)
    {
        ROS_INFO("recieve msg = %d", msg->stamp);      // Shows the 'stamp.sec' message
...
{
    ros::init(argc, argv, "topic_subscriber");  // Initialises Node Name
